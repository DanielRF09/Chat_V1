...
socket.on('mensaje', function (data) {
  ...
  if (data.id == socket.id) {
    ...
    <div class="local-message">
      ...
      <img src="https://www.inmosenna.com/wp-content/uploads/2018/07/avatar-user-business-man-399587fe24739d5a-512x512.png" width="35px" height="35px"></img>
      <p>${sanitized}</p>
    </div>
    `;
    ...
    <div class="remote-message">
      <img src="https://cdn4.iconfinder.com/data/icons/avatars-xmas-giveaway/128/batman_hero_avatar_comics-512.png" width="35px" height="35px"></img>
      <strong>${data.username}: </strong>
      <p>${sanitized}</p>
    </div>
    `;
